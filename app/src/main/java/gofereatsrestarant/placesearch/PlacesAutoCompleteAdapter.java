package gofereatsrestarant.placesearch;
...
public class PlacesAutoCompleteAdapter
    ...
    /**
     * To return auto complete based on filter
     *
     * @param constraint charsequeuce that are entered in the text view
     * @return Returns place complete array list
     */
