...
public class BaseDialogFragment extends DialogFragment {
    ...
    /**
     * Default Constructor of Base Dialog Fragment
     */
    ...
    /**
     * To intialize layout id of the  custom dialog layout  to make the dialog not cancellable while api calls
     *
     * @param layoutId layout id of the custom dialog layout
     */
